...
[![Coverage](https://img.shields.io/badge/coverage-88.8%25-brightgreen.svg)](https://github.com/juburr/openai-tool-adapter)
...
* **🔄 OpenAI SDK Compatible** - Uses official `github.com/openai/openai-go/v3` types for seamless integration
...
### Installation
```bash
go get github.com/juburr/openai-tool-adapter/v3
